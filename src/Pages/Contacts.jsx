...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <Button id="create_button" variant="contained"><Link to="/contact_form">
                    Create Contact
                </Link></Button>
            ...
            {AllContacts.length == 0 && <div className=" m-auto w-fit p-4 align-middle text-blue-500 justify-center">
                ...
                <h1 className="warning">No Contact Found.<br />Please add contact from 'Create Contact' Button.</h1>
            </div>}
